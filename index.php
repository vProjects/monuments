...
<body>
	...
	<div class="row row-tp-home mrgn-nul scrollblock">
		<div class="col-sm-12">
			<div class="container">
			...
			<div class="banner-tp">
				<img src="images/heaven.png" class="img-responsive img-heaven" />
			</div><!-- banner-tp -->
			<div class="logo-pos-hm">
				<div class="img-logo">
	...
	<div class="row row-main-form mrgn-nul">
		<div class="col-sm-12">
			<div class="container">
					...
					<div class="main-home-cont">
						<div class="row row-bx">
							<div class="col-sm-4">
								<div class="container-bx-home fade-in-left">
									<img src="images/home-tp-img-1.png" class="img-responsive img-bx" />
									<div class="txt-bx">
										<h3 class="hd-bx">
											Lorem Ipsumlorem
										</h3>
							...
							<div class="col-sm-4">
								<div class="container-bx-home">
									<img src="images/home-tp-img-2.png" class="img-responsive img-bx" />
									<div class="txt-bx">
										<h3 class="hd-bx">
											Lorem Ipsumlorem
										</h3>
							...
							<div class="col-sm-4">
								<div class="container-bx-home fade-in-right">
									<img src="images/home-tp-img-3.png" class="img-responsive img-bx" />
									<div class="txt-bx">
										<h3 class="hd-bx">
											Lorem Ipsumlorem
										</h3>
					...
					<div class="main-home-cont">
						<div class="row">
							<div class="col-sm-6 fade-in-left">
								<div class="cont-bx-img-abt">
									<img src="images/fort-mdle.png" class="img-responsive img-abt" />
									<a href="#">
										<div class="txt-abt-bx">
											<h3 class="hd-abt">
												About Us
											</h3>
											<p class="para-abt">
											...
											<div class="row">
												<div class="col-xs-3 col-sm-4">
													<div class="line-img-abt">
													</div>
												</div>
												<div class="col-xs-6 col-sm-4">
													<h3 class="hd-abt-learn">
														Learn More
													</h3>
												</div>
												<div class="col-xs-3 col-sm-4">
							...
							<div class="col-sm-6 fade-in-right">
								<div class="cont-bx-img-abt">
									<img src="images/cloud-mdle.png" class="img-responsive img-abt" />
									<a href="#">
										<div class="txt-abt-bx">
											<h3 class="hd-abt">
												About Us
					...
					<div class="row row-deco-btm">
						...
						<div class="col-xs-4">
							<h3 class="home-head-team">Our team</h3>
						</div>
						<div class="col-xs-4">
							<img src="images/decoration.png" class="img-responsive" />
						</div>
					...
					<div class="main-home-cont btm-team-hm">
						<div class="row row-bx">
							...
							<div class="col-sm-4 fade-in-right">
								<div class="container-bx-home">
